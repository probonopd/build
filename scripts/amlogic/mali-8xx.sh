...
build_mali_aml()
{
	...
	cp -R $SRC/lib/scripts/amlogic/mali-aml-8xx/* $SOURCES/$plugin_dir/
...
chroot $CACHEDIR/$SDCARD /bin/bash -c "dpkg -i /tmp/debs/mali-aml-8xx_${REVISION}_${ARCH}.deb" >> $DEST/debug/install.log
